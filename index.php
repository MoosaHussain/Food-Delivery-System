        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/xyz.png" alt=""> </a>
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='search.php'" type="button" class="btn theme-btn btn-lg">Search food</button>
                        </form>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/xyz" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
